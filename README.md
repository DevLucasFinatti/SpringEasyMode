...
## Lista de projetos 
•  ([SpringSecurity](https://github.com/DevLucasFinatti/SpringEasyMode/tree/main/SpringSecurityBase))
•  ([Design Patterns](https://github.com/DevLucasFinatti/SpringEasyMode/tree/main/Design%20Patterns))
...
Sinta-se à vontade para explorar os projetos, fazer fork, ou contribuir com suas próprias implementações e ideias no meu [e-mail](mailto:lucasfinatticode@gmail.com). Juntos, podemos construir uma base de conhecimento rica em Spring Boot!

## Contato

Para sugestões ou perguntas, entre em contato através do meu [e-mail](mailto:lucasfinatticode@gmail.com) ou do meu [LinkedIn](https://linkedin.com/in/lucas-finatti/).
